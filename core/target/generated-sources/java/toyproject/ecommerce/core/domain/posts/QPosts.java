...
public class QPosts extends EntityPathBase<Posts> {
    ...
    private static final long serialVersionUID = 1663548284L;

    public static final QPosts posts = new QPosts("posts");

    public final toyproject.ecommerce.core.domain.QBaseTimeEntity _super = new toyproject.ecommerce.core.domain.QBaseTimeEntity(this);
